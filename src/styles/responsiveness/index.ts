...
import { ResponsiveDecleration, CSSProperty, ResponsiveCSSDecleration } from "./types"

export const getResponsiveCSSPropertyValue = (value: string | number): string | `${number}px` => {
